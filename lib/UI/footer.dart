        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              /// copyright text
              /// (v1.8.2)
              const Text("© Copyright 2024 handmade with Flutter 💙", textAlign: TextAlign.center, style: TextStyle(
                color: Colors.white, fontSize: 12
              )),
              const Text("Last updated: 20 July 2024", textAlign: TextAlign.center, style: TextStyle(
